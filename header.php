...
<header class="header">
    <div class="content-wrap">
        <div class="header-wrap">
            ...
            <div class="main-nav-wrap js_mobile-nav">
                <ul class="main-nav">
                    <?php
                    if( have_rows('header', 'option') ):
                        while( have_rows('header', 'option') ) : the_row();
                            ...
                            $dropdown = ($dropdown == 'Yes') ? $class = "arrow-link" : $class = "";
                    ?>
                    <li class="<?php echo $class; ?>">
                        <a href="<?php echo $link['url']; ?>"><?php echo $link['title']; ?></a>
                        <div class="submenu-wrap">
                            <ul class="submenu" <?php echo ($link['title'] == 'About' || $link['title'] == 'Residential' || $link['title'] == 'Locations') ? ' style="grid-template-columns: repeat(1, 1fr);"' : ''; ?>>
                                <?php
                                if( have_rows('sub_links', 'option') ):
                                    while( have_rows('sub_links', 'option') ) : the_row();
                                        $icon = get_sub_field('icon');
                                        $sub_link = get_sub_field('sub_link');
                                        $description = get_sub_field('description');
                                ?>
                                <li>
                                    <a class="submenu-link" href="<?php echo $sub_link['url']; ?>">
                                        <div class="submenu-link-img">
                                            <img src="<?php echo $icon; ?>" alt="">
                                        </div>
                                        <div class="submenu-link-text">
                                            <h4><?php echo $sub_link['title']; ?></h4>
            ...
            <div class="header-buttons-wrapper">
                <a href="tel:<?php echo '+1' . $hero['phone_number']; ?>" class="custom-btn custom-btn--small custom-btn--darkblue">
                ...
                <a href="<?php echo $hero['call_to_action_button_link']; ?>"  class="custom-btn custom-btn--small">
