<?php /* Template Name: Item Category Page */ ?>
	...
	<section class="item-wrap">
		...
		<div class="item-nav">
			...
			$args = array(
				...
				'meta_value' => 'item-category-page.php',
			);
			...
			if ($query->have_posts()) {
				while ($query->have_posts()) {
					$query->the_post();
					echo '<a href="' . get_permalink() . '" ' . (get_permalink() == $current_url ? ' class="active" ' : '') . '>';
					echo '<img src="' . get_template_directory_uri() . '/img/svg/fi-rr-angle-small-right-green.svg" />';
					the_title();
					echo '</a>';
				}
			}
