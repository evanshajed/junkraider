...
$our_equipment_and_team = get_field('our_equipment_and_team');
$how_we_do_it = get_field('how_we_do_it');
$more_than_demolition = get_field('more_than_demolition');
        ...
        <div class="content-wrap">
            <div class="text-with-img-flex">
                <div class="text-with-img-text">
                    ...
                    <p><?php echo $what_we_do['description']; ?></p>
                </div>
                <div class="text-with-img-img">
                    <img src="<?php echo $what_we_do['picture']; ?>" alt="">
                </div>
            </div>
        </div>
    </section>
...
<section class="reasons">
    <div class="content-wrap">
        <div class="section-title">
            <h2><?php echo $locations['title']; ?></h2>
            <p><?php echo $locations['description']; ?></p>
        </div>
        <div class="content-grid content-grid--4">
            <?php
...
<?php endif; ?>
    ...
    <section class="steps">
        <div class="content-wrap">
            ...
            <div class="content-grid content-grid--vertical">
                <?php
                $number = 0;
    ...
    <section class="reasons">
        <div class="content-wrap">
            <div class="section-title">
                <h2><?php echo $more_than_demolition['title']; ?></h2>
                <p><?php echo $more_than_demolition['description']; ?></p>
                <p><b><?php echo $more_than_demolition['additional_line']; ?></b></p>
            </div>
            <div class="content-grid content-grid--3">
                <?php
                if( have_rows('more_than_demolition') ):
                    while( have_rows('more_than_demolition') ): the_row();
                        if( have_rows('list') ):
                            while( have_rows('list') ): the_row();
                                $icon = get_sub_field('icon');
                                $title = get_sub_field('title');
