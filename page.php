<?php
/* Template Name: Commercial Service */
...
<body class="commercial-services">
    ...
    <main>
        <?php if ( Plugin::$instance->documents->get(get_the_ID())->is_built_with_elementor() ) : ?>
            <!-- Elementor content will be rendered here -->
        ...
        <div class="content-wrap">
            <div class="text-with-img-flex text-with-img-flex--reverse">
                <div class="text-with-img-text">
                    <h2><?php echo $block_1['title']; ?></h2>
                    <?php echo $block_1['description']; ?>
                </div>
                <div class="text-with-img-img">
                    <img src="<?php echo $block_1['picture']; ?>" alt="">
                </div>
            </div>
        </div>
    </section>
    <section class="text-with-img">
        <div class="content-wrap">
            <div class="text-with-img-flex">
                <div class="text-with-img-text">
                    <h2><?php echo $block_2['title']; ?></h2>
                    <?php echo $block_2['description']; ?>
                </div>
                <div class="text-with-img-img">
                    <img src="<?php echo $block_2['picture']; ?>" alt="">
                </div>
            </div>
        </div>
    </section>
    <?php if ($what_we_remove['title']): ?>
    <section class="remove">
        <div class="content-wrap">
            <div class="remove-inner">
                <div class="remove-title">
                    <h2><?php echo $what_we_remove['title']; ?></h2>
                </div>
                <div class="remove-items">
                    <?php
                    if( have_rows('what_we_remove') ):
                        while( have_rows('what_we_remove') ): the_row();
                            if( have_rows('items') ):
                    ...
                    <div class="remove-item">
                        <div class="remove-item_img">
                            <img src="<?php echo $icon; ?>" alt="">
                        </div>
                        <div class="remove-item_text">
    ...
    <section class="process">
        <div class="content-wrap">
            ...
            <div class="content-grid">
                <?php
                $counter = 0;
                if( have_rows('our_junk_removal_process', 11) ):
                    while( have_rows('our_junk_removal_process', 11) ): the_row();
                        if( have_rows('process', 11) ):
                            while( have_rows('process', 11) ): the_row();
                                $counter++;
                                $icon = get_sub_field('icon');
                                $title = get_sub_field('title');
                                ?>
    ...
    <section class="reasons">
        <div class="content-wrap">
            <div class="section-title">
                <?php echo $why_junk_raider['title']; ?>
            </div>
            <div class="content-grid">
                <?php
                if( have_rows('why_junk_raider') ):
                    while( have_rows('why_junk_raider') ): the_row();
...
<?php endif; ?>
    ...
    <section class="items" id="items-we-take">
        <div class="content-wrap">
            <div class="items-wrap">
                ...
                <div class="tabs">
                    ...
                    <div class="tabs-content js_tabs-content">
                        <?php
                        if( have_rows('items_we_take', 11) ):
                            while( have_rows('items_we_take', 11) ): the_row();
                                if( have_rows('tabs', 11) ):
                                    while( have_rows('tabs', 11) ): the_row();
                                        $tab_title = get_sub_field('tab_title');
                                        ?>
                                        <div class="tab" id="<?php echo $tab_title; ?>">
                                            <ul class="tab-list">
                                                <?php
                                                if( have_rows('item_name', 11) ):
                                                    while( have_rows('item_name', 11) ): the_row();
                                                        $title = get_sub_field('title');
                                                        ?>
            ...
            <div class="booking-grid">
                <div class="booking-title">
                    ...
                    <div class="section-title-flex">
                        <a href="<?php echo $hero['call_to_action_button_link']; ?>" target="_blank" class="custom-btn custom-btn--white">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
